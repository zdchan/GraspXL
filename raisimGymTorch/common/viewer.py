...
materials = {
    ...
    "wood": Material(color=(0.051, 0.659, 0.051, 1.0), ambient=0.2),
    "box": Material(color=(0.835, 0.651, 0.49, 1.0), ambient=0.2),
    "ketchup": Material(color=(0.969, 0.106, 0.059, 1.0), ambient=0.2),
    "mixer": Material(color=(131.0/255.0, 186.0/255.0, 161.0/255.0, 1.0), ambient=0.2),
