...
from raisimGymTorch.env.bin import ours_floating as mano
from raisimGymTorch.env.RaisimGymVecEnvOther import RaisimGymVecEnvTest as VecEnv
from raisimGymTorch.helper.raisim_gym_helper import ConfigurationSaver, load_param, tensorboard_launcher
from raisimGymTorch.env.bin.ours_floating import NormalSampler
...
for update in range(args.num_iterations):
    ...
    for step in range(n_steps_r):
        ...
        for i in range(num_envs):
            ...
            rewards_r[i]['reward_sum'] = (rewards_r[i]['reward_sum'] + rewards_r[i]['affordance_reward'] + rewards_r[i]['anatomy_reward'] + rewards_r[i]['direction_reward'] + rewards_r[i]['center_reward']
