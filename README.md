...
## News
[2024.08] **Code released! We also released the URDF files (See [docs/INSTALLATION.md](./docs/INSTALLATION.md)) for the Objaverse objects we use to generate motions in the simulation**
